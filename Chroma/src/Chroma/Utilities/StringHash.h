...
private:
	...
	static constexpr Type Hash_Internal(const char *const str, const Type value) noexcept
	{
...
public:
	...
	constexpr operator Type() const { return m_Hash; }

	bool operator==(const BasicHash &rhs) const { return m_Hash == rhs.m_Hash; }
	bool operator!=(const BasicHash &rhs) const { return m_Hash != rhs.m_Hash; }
	bool operator<(const BasicHash &rhs) const { return m_Hash < rhs.m_Hash; }
	bool operator>(const BasicHash &rhs) const { return m_Hash > rhs.m_Hash; }
