...
namespace Chroma
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadVertexBuffer->SetLayout({
			...
			{ Chroma::ShaderDataType::Float2, "a_TristonCoord" }
		});
	...
	{
		DrawQuad({ position.x, position.y, 0.0f }, size, texture, glm::vec4(1.0f), rotation);
	}
	...
	void Renderer2D::DrawQuadTriston(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, const glm::vec2& tristonCoord, float rotation)
	{
		...
		s_Data.QuadVertexBufferPtr->TexCoord = { 0.0f, 0.0f };
		s_Data.QuadVertexBufferPtr->TexIndex = textureIndex;
		s_Data.QuadVertexBufferPtr->TristonCoord = tristonCoord;
		s_Data.QuadVertexBufferPtr++;
