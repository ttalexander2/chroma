...
namespace ImGui
{
    ...
    static const int ImGuiStyle_Count = 38;

    enum class ImGuiStylePreset
    {
        ChromaDark,
        ChromaPurple,
        DefaultClassic,
    ...
    static const char* DefaultStyleNames[ImGuiStyle_Count] = { "ChromaDark",
                                                          "ChromaPurple",
                                                          "DefaultClassic",
                                                          "DefaultDark",
                                                          "DefaultLight",
    ...
    static inline ImVec4 ConvertTitleBgColFromPrevVersion(const ImVec4& win_bg_col, const ImVec4& title_bg_col)
    {
        ...
        return ImVec4((win_bg_col.x * win_bg_col.w + title_bg_col.x) * k,
            (win_bg_col.y * win_bg_col.w + title_bg_col.y) * k,
    ...
    static inline void CreateDefaultTabColorsFor(ImGuiStyle& style, ImGuiCol baseHoveredColor = ImGuiCol_HeaderHovered,
        float hoveredLerp = 0.5f, const ImVec2& tabsLerps = ImVec2(0.15f, 0.8f),
    ...
    static bool ResetStyle(ImGuiStylePreset styleEnum, ImGuiStyle& style)
    {
        if ((int)styleEnum < 0 || (int)styleEnum >= ImGuiStyle_Count)
            return false;
        style = ImGuiStyle();
        switch (styleEnum)
        {
        case ImGuiStylePreset::DefaultClassic:
            ImGui::StyleColorsClassic(&style);
            break;
        case ImGuiStylePreset::DefaultDark:
            ImGui::StyleColorsDark(&style);
            break;
        case ImGuiStylePreset::DefaultLight:
            ImGui::StyleColorsLight(&style);
            break;
        case ImGuiStylePreset::ChromaDark: {
            ...
            colors[ImGuiCol_Border] = ImVec4(0.48f, 0.48f, 0.48f, 1.00f);
            colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
            colors[ImGuiCol_FrameBg] = ImVec4(0.27f, 0.29f, 0.31f, 0.54f);
            colors[ImGuiCol_FrameBgHovered] = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
            colors[ImGuiCol_FrameBgActive] = ImVec4(0.10f, 0.51f, 1.00f, 0.67f);
            ...
            colors[ImGuiCol_HeaderActive] = ImVec4(0.09f, 0.51f, 1.00f, 1.00f);
            ...
            colors[ImGuiCol_TabHovered] = ImVec4(0.37f, 0.66f, 1.00f, 1.00f);
            colors[ImGuiCol_TabActive] = ImVec4(0.19f, 0.51f, 0.94f, 1.00f);
        ...
        case ImGuiStylePreset::Gray: {
            ...
            style.Colors[ImGuiCol_TitleBg] = ImGui::ConvertTitleBgColFromPrevVersion(style.Colors[ImGuiCol_WindowBg],
                ImVec4(0.26f, 0.27f, 0.74f, 1.00f));
            style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.28f, 0.28f, 0.76f, 0.16f);
            style.Colors[ImGuiCol_TitleBgActive] = ImGui::ConvertTitleBgColFromPrevVersion(
                style.Colors[ImGuiCol_WindowBg], ImVec4(0.50f, 0.50f, 1.00f, 0.55f));
        ...
        case ImGuiStylePreset::Light: {
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_TitleBg, 0.9f, ImVec2(0.25f, 0.8f), ImVec2(0.15f, 0.6f));
                             ...
                             break;
        case ImGuiStylePreset::DarkOpaque:
        case ImGuiStylePreset::DarkOpaqueInverse: {
            style.AntiAliasedLines = true;
            style.AntiAliasedFill = true;
            style.CurveTessellationTol = 1.25f;
            style.Alpha = 1.f;
            ...
            if (styleEnum == ImGuiStylePreset::DarkOpaqueInverse)
            {
        ...
        case ImGuiStylePreset::Soft: {
            ...
            CreateDefaultTabColorsFor(style);
                            ...
                            break;
        case ImGuiStylePreset::EdinBlack: {
            ...
            CreateDefaultTabColorsFor(style);
                                 ...
                                 break;
        case ImGuiStylePreset::EdinWhite: {
            // style based on an image posted by edin_p in the screenshot section (part 3) of Dear ImGui Issue Section.
            style.WindowRounding = 6.f;
            style.ScrollbarRounding = 2.f;
            style.WindowTitleAlign.x = 0.45f;
        ...
        case ImGuiStylePreset::Maya: {
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_ResizeGrip, 0.7f, ImVec2(0.25f, 0.8f), ImVec2(0.1f, 0.6f));
                            ...
                            break;
        case ImGuiStylePreset::GrayCodz01:
        case ImGuiStylePreset::GrayCodz01Inverse: {
            ...
            if (styleEnum == ImGuiStylePreset::GrayCodz01Inverse)
            {
                InvertStyleColors(style);
                // style.Colors[ImGuiCol_PopupBg]	     = ImVec4(0.99f, 0.96f, 1.00f, 1.00f);
            }
            ...
            CreateDefaultTabColorsFor(style);
                                         ...
                                         break;
        case ImGuiStylePreset::BlackCodz01: {
            // Posted by @codz01 here: https://github.com/ocornut/imgui/issues/707 (hope I can use it)

            // Actually these values are taken from ImGuiStylePreset::GrayCodz01:
            style.AntiAliasedLines = true;
            style.AntiAliasedFill = true;
            style.CurveTessellationTol = 1.25f;
            style.Alpha = 1.f;
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_HeaderHovered, 0.4f, ImVec2(0.3f, 0.7f), ImVec2(0.1f, 0.5f));
                                   ...
                                   break;
        case ImGuiStylePreset::DarkCodz01: {
            // Posted by @codz01 here: https://github.com/ocornut/imgui/issues/707 (hope I can use it)
            ...
            style.Colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                  ...
                                  break;
        case ImGuiStylePreset::Purple:
        case ImGuiStylePreset::PurpleInverse: {
            ...
            if (styleEnum == ImGuiStylePreset::PurpleInverse)
            {
                InvertStyleColors(style);
                // style.Colors[ImGuiCol_PopupBg]	     = ImVec4(0.99f, 0.96f, 1.00f, 1.00f);
            }
    ...
    #undef CHERRY_TEXT
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_HeaderHovered, 0.65f, ImVec2(0.4f, 0.6f), ImVec2(0.2f, 0.4f));
                              ...
                              break;
        case ImGuiStylePreset::LightGreen:
        case ImGuiStylePreset::LightGreenInverse: {
            ...
            if (styleEnum == ImGuiStylePreset::LightGreenInverse)
            {
                InvertStyleColors(style);
                // style.Colors[ImGuiCol_PopupBg]	     = ImVec4(0.99f, 0.96f, 1.00f, 1.00f);
            }
            ...
            CreateDefaultTabColorsFor(style);
                                         ...
                                         break;
        case ImGuiStylePreset::Design:
        case ImGuiStylePreset::DesignInverse: {
            // Posted by @usernameiwantedwasalreadytaken here: https://github.com/ocornut/imgui/issues/707 (hope I can use
            // it)
            float hspacing = 8.f;
            float vspacing = 6.f;
            ...
            if (styleEnum == ImGuiStylePreset::DesignInverse)
            {
                InvertStyleColors(style);
                // style.Colors[ImGuiCol_PopupBg]	     = ImVec4(0.99f, 0.96f, 1.00f, 1.00f);
            }
        ...
        case ImGuiStylePreset::Dracula: {
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_Header, 1.0f, ImVec2(0.15f, 1.0f), ImVec2(0.05f, 0.9f));
                               ...
                               break;
        case ImGuiStylePreset::Greenish: {
            ...
            CreateDefaultTabColorsFor(style, ImGuiCol_Header, 0.35f);
                                ...
                                break;
        case ImGuiStylePreset::C64: {
            // Posted by @Nullious here: https://gist.github.com/Nullious/2d598963b346c49fa4500ca16b8e5c67 (Hope I can use
            // it) Recommended fonts here: https://www.kreativekorp.com/software/fonts/c64.shtml
            ...
            style.TabBorderSize = style.TabRounding = 0;
                           ...
                           break;
        case ImGuiStylePreset::PhotoStore: {
            ...
            // style.Colors[ImGuiCol_DockingEmptyBg]         = ImVec4(0.180f, 0.180f, 0.180f, 1.000f);
                                  ...
                                  break;
        case ImGuiStylePreset::CorporateGreyFlat:
        case ImGuiStylePreset::CorporateGreyFramed: {
            // Posted by @malamanteau here: https://github.com/ocornut/imgui/issues/707 (hope I can use it)
            /// 0 = FLAT APPEARENCE; 1 = MORE "3D" LOOK
            const int is3D = (styleEnum == ImGuiStylePreset::CorporateGreyFramed) ? 1 : 0;
            ...
            style.Colors[ImGuiCol_DockingPreview] = ImVec4(0.85f, 0.85f, 0.85f, 0.28f);
                                           ...
                                           break;
        case ImGuiStylePreset::VisualDark: {
            ...
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                  ...
                                  break;
        case ImGuiStylePreset::SteamingLife: {
            ...
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                    ...
                                    break;
        case ImGuiStylePreset::SoftLife: {
            // Just a quick variation of ImGuiStylePreset::SteamingLife style
            ...
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                ...
                                break;
        case ImGuiStylePreset::GoldenBlack: {
            ...
            // colors[ImGuiCol_DockingEmptyBg]         = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                   ...
                                   break;
        case ImGuiStylePreset::Windowed: {
            // Badly adapted from the Win98-DearImgui customization made by @JakeCoxon in his fork here
            // https://github.com/JakeCoxon/imgui-win98 (hope I can use it) Suggested font: MS Sans Serif.ttf
            ImGuiStyle& style = ImGui::GetStyle();
            ImVec4* colors = style.Colors;
            ...
            colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);
                                ...
                                break;
        case ImGuiStylePreset::OverShiftedBlack: {
            ...
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
                                        ...
                                        break;
        case ImGuiStylePreset::AieKickGreenBlue: {
            ...
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.13f, 0.13f, 0.13f, 0.80f);
                                        ...
                                        break;
        case ImGuiStylePreset::AieKickRedDark: {
            // Posted by @aiekick here: https://github.com/ocornut/imgui/issues/707 (hope I can use it)
            // @aiekick suggest used Roboto-Medium.ttf font with it (in imgui/misc/font directory)
            ImGuiStyle& style = ImGui::GetStyle();
        ...
        case ImGuiStylePreset::ChromaPurple: {
            ImVec4* colors = ImGui::GetStyle().Colors;
            colors[ImGuiCol_Text] = ImVec4(0.81f, 0.77f, 1.00f, 1.00f);
            colors[ImGuiCol_TextDisabled] = ImVec4(0.52f, 0.48f, 0.70f, 1.00f);
            colors[ImGuiCol_WindowBg] = ImVec4(0.04f, 0.06f, 0.20f, 1.00f);
            colors[ImGuiCol_ChildBg] = ImVec4(0.04f, 0.06f, 0.20f, 1.00f);
            colors[ImGuiCol_PopupBg] = ImVec4(0.06f, 0.11f, 0.26f, 1.00f);
            colors[ImGuiCol_Border] = ImVec4(0.25f, 0.53f, 0.54f, 0.16f);
            colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
            colors[ImGuiCol_FrameBg] = ImVec4(0.67f, 0.68f, 0.96f, 0.14f);
            colors[ImGuiCol_FrameBgHovered] = ImVec4(0.67f, 0.68f, 0.96f, 0.31f);
            colors[ImGuiCol_FrameBgActive] = ImVec4(0.67f, 0.68f, 0.96f, 0.58f);
            colors[ImGuiCol_TitleBg] = ImVec4(0.05f, 0.03f, 0.14f, 1.00f);
            colors[ImGuiCol_TitleBgActive] = ImVec4(0.06f, 0.04f, 0.19f, 1.00f);
            colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.13f, 0.08f, 0.22f, 0.75f);
            colors[ImGuiCol_MenuBarBg] = ImVec4(0.12f, 0.01f, 0.25f, 0.47f);
            colors[ImGuiCol_ScrollbarBg] = ImVec4(0.02f, 0.01f, 0.15f, 1.00f);
            colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.15f, 0.68f, 0.84f, 0.53f);
            colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.15f, 0.68f, 0.84f, 0.81f);
            colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.15f, 0.68f, 0.84f, 1.00f);
            colors[ImGuiCol_CheckMark] = ImVec4(0.07f, 0.70f, 1.00f, 1.00f);
            colors[ImGuiCol_SliderGrab] = ImVec4(0.15f, 0.68f, 0.84f, 1.00f);
            colors[ImGuiCol_SliderGrabActive] = ImVec4(0.17f, 0.78f, 0.95f, 1.00f);
            colors[ImGuiCol_Button] = ImVec4(0.00f, 0.41f, 0.58f, 0.53f);
            colors[ImGuiCol_ButtonHovered] = ImVec4(0.00f, 0.41f, 0.57f, 1.00f);
            colors[ImGuiCol_ButtonActive] = ImVec4(0.00f, 0.50f, 0.71f, 1.00f);
            colors[ImGuiCol_Header] = ImVec4(0.21f, 0.00f, 0.42f, 1.00f);
            colors[ImGuiCol_HeaderHovered] = ImVec4(0.25f, 0.00f, 0.51f, 1.00f);
            colors[ImGuiCol_HeaderActive] = ImVec4(0.32f, 0.00f, 0.64f, 1.00f);
            colors[ImGuiCol_Separator] = ImVec4(0.58f, 0.99f, 1.00f, 0.20f);
            colors[ImGuiCol_SeparatorHovered] = ImVec4(0.58f, 0.99f, 1.00f, 0.32f);
            colors[ImGuiCol_SeparatorActive] = ImVec4(0.58f, 0.99f, 1.00f, 0.60f);
            colors[ImGuiCol_ResizeGrip] = ImVec4(0.58f, 0.99f, 1.00f, 0.20f);
            colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.58f, 0.99f, 1.00f, 0.34f);
            colors[ImGuiCol_ResizeGripActive] = ImVec4(0.58f, 0.99f, 1.00f, 0.67f);
            colors[ImGuiCol_Tab] = ImVec4(0.21f, 0.00f, 0.42f, 1.00f);
            colors[ImGuiCol_TabHovered] = ImVec4(0.31f, 0.00f, 0.63f, 1.00f);
            colors[ImGuiCol_TabActive] = ImVec4(0.41f, 0.00f, 0.83f, 1.00f);
            colors[ImGuiCol_TabUnfocused] = ImVec4(0.21f, 0.00f, 0.42f, 1.00f);
            colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.31f, 0.00f, 0.63f, 1.00f);
            colors[ImGuiCol_DockingPreview] = ImVec4(0.00f, 0.30f, 0.55f, 1.00f);
            colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.07f, 0.04f, 0.11f, 0.62f);
            colors[ImGuiCol_PlotLines] = ImVec4(0.30f, 0.72f, 0.73f, 0.63f);
            colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.00f, 1.00f, 0.91f, 0.63f);
            colors[ImGuiCol_PlotHistogram] = ImVec4(0.30f, 0.72f, 0.73f, 0.63f);
            colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.00f, 1.00f, 0.92f, 0.63f);
            colors[ImGuiCol_TableHeaderBg] = ImVec4(0.18f, 0.10f, 0.44f, 1.00f);
            colors[ImGuiCol_TableBorderStrong] = ImVec4(0.58f, 0.99f, 1.00f, 1.00f);
            colors[ImGuiCol_TableBorderLight] = ImVec4(0.58f, 0.99f, 1.00f, 0.20f);
            colors[ImGuiCol_TableRowBg] = ImVec4(0.03f, 0.06f, 0.20f, 1.00f);
            colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.00f, 1.00f, 1.00f, 0.06f);
            colors[ImGuiCol_TextSelectedBg] = ImVec4(0.13f, 0.09f, 0.47f, 0.43f);
            colors[ImGuiCol_DragDropTarget] = ImVec4(0.88f, 0.00f, 1.00f, 0.90f);
            colors[ImGuiCol_NavHighlight] = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
            colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
            colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
    ...
    static bool SelectStyleCombo(const char* label, int* selectedIndex, int maxNumItemsToDisplay, ImGuiStyle* styleToChange)
    {
        bool changed = false;
        if (!styleToChange)
            styleToChange = &ImGui::GetStyle();
        if ((changed = ImGui::Combo(label, selectedIndex, ImGui::GetDefaultStyleNames(), ImGuiStyle_Count, maxNumItemsToDisplay)))
        {
            ResetStyle((ImGuiStylePreset)*selectedIndex, *styleToChange);
        }
        return changed;
    }
